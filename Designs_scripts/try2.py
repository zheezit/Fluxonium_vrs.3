...
def name_chip(cell, 
              ...
              position_name = (0,0),
              fond_size = 200):
    Qdev = gdspy.Text("SQuID Lab, QDev", fond_size, (position_name[0]+2500, position_name[1]+500))
    name = gdspy.Text("{}".format(cell.name), fond_size, (position_name[0]+1500, -position_name[1]+500), layer=layer_name)
    cell.add(Qdev)
    cell.add(name)
