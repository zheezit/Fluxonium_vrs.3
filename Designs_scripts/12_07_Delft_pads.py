...
from GDSpy_Modules.devdesign.JJsdesign.jj import *
from GDSpy_Modules.devdesign.essentials.shapes import *
from GDSpy_Modules.devdesign.essentials.essentials import *
...
device, jj_cell = DUT_manhattan_classic_patch(0.315, 53)

# chip = gdspy.Cell("Chip")
# chip.add(gdspy.CellArray(device, 10, 12, (900, 700)))

# writer = gdspy.GdsWriter("/Users/federicopoggiali/Desktop/JJ_315.gds", unit=1.0e-6, precision=1.0e-9)
