...
\begin{document}
    ...
    \pagenumbering{arabic}
        \part{Why is Fluxonium so interesting?}\label{part:I}
            ...
            \include{introduction/outline.tex}
        \part{Background - The building blocks of superconducting qubits: circuit elements}\label{part:II}
            \include{background/background}
            \include{background/resonators}
            \include{background/jj}
            \include{background/array_jj}
            \include{background/Super_conducting_qubits}
            \include{background/experimental perspective}
        ...
        \part{Design and Fabrication}\label{part:IV} % i could make this section to "Design, fabrication- and characterization methods. and then put measuremnt setup in the next section 
            \include{Design_fabrication/design}
            \include{Design_fabrication/fabrication}
        \part{Characterization and measurement}\label{part:V}
            \include{characterization_measurements/Measurement_setup}
            \include{characterization_measurements/characterization}
